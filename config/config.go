...
import (
	...
	"github.com/Allenxuxu/stark/config/loader"
	"github.com/Allenxuxu/stark/config/reader"
	"github.com/Allenxuxu/stark/config/source"
	"github.com/Allenxuxu/stark/config/storage"
	"github.com/Allenxuxu/stark/config/storage/file"
...
func newConfig(opts ...Option) (Config, error) {
	...
	if options.Storage {
		...
		f := filepath.Join(dir, "stark_config.conf")
